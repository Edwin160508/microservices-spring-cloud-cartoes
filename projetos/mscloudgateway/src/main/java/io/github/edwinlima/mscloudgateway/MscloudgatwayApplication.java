package io.github.edwinlima.mscloudgateway;
...
@EnableEurekaClient
@EnableDiscoveryClient/*Annotation informando que esta aplicação e um gerenciador de portas*/
public class MscloudgatwayApplication {
	...
	@Bean
	public RouteLocator rautes(RouteLocatorBuilder builder){
		return builder
				.routes()
